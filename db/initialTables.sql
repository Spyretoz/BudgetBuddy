...
CREATE TABLE PRICE_HIST (
    ...
    PRICE_HIST_PROD_ID INT,
    PRICE_HIST_USER_ID INT,
...
-- INSERT INTO PRODUCT(MANUFACTURER, PROD_NAME, DESCRIPTION, PROD_YEAR, PROD_CATEGORY, PROD_SUB_CATEGORY, GUARANTEE)
-- VALUES ('Apple', 'Iphone 13 Mini', E'Apple\'s latest smartphone', 2021, 'Technology', 'Phones', 1);